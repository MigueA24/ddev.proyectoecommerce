...
jQuery(document).ready(function() {
  ...
  // Función para regenerar la galería
  function regenerarGaleria() {
    // Coloca aquí el código para regenerar la galería inferior
    // Puedes reinicializar la galería o cargar nuevas imágenes según tus necesidades
    // Por ejemplo, puedes cargar las imágenes desde un arreglo de URLs
    var nuevasImagenes = ["nueva_imagen_1.jpg", "nueva_imagen_2.jpg", "nueva_imagen_3.jpg"];

    // Limpia la galería existente
    jQuery("#galeria").empty();

    // Agrega las nuevas imágenes a la galería
    for (var i = 0; i < nuevasImagenes.length; i++) {
      jQuery("#galeria").append('<a href="#" data-image="' + nuevasImagenes[i] + '">Imagen ' + (i + 1) + '</a>');
    }

    // Agrega el evento click a las nuevas imágenes
    jQuery("#galeria a").click(function() {
      // Lógica del click, similar a la que ya tienes
      // ...
      return false;
    });
  }
  ...
  jQuery("#galeria a").click(function() {
    ...
    if (dataimagen === undefined) {
      ...
      jQuery("#divimagengrande").fadeOut(function() {
        ...
        // Dentro del div divimagengrande sustituimos el HTML y lo reconstruimos con los datos de las variables recibidas.
        // Si no hacemos esto, aunque la imagen grande se sustituirá, el zoom se quedará con la primera imagen.
        ...
        jQuery("#divimagengrande").fadeIn(function() {
          // Después de ejecutar el fadein, llamamos a la función para regenerar la galería
          regenerarGaleria();
        });
