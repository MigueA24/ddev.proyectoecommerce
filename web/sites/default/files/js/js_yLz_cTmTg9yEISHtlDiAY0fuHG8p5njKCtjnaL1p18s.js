...
jQuery("document").ready(function()
{
  ...
  jQuery("#galeria a").click(function(){
    ...
    function recargarPagina() {
      location.reload(); // O puedes usar location.reload(true);
    }

// Manejar clics en el documento
    document.addEventListener('click', function(event) {
      // Verificar si el clic no ocurrió dentro de las imágenes o divimagengrande
      var esImagen = event.target.tagName === 'IMG';
      var esDivImagenGrande = event.target.id === 'divimagengrande';

      if (!esImagen && !esDivImagenGrande) {
        // Si el clic no fue en una imagen ni en divimagengrande, recargar la página
        recargarPagina();
      }
    });
