...
jQuery("document").ready(function() {
  ...
  jQuery("#galeria a").click(function() {
    ...
    if (dataimagen === undefined) {
      ...
      // Clonamos el elemento de la imagen
      var newImage = jQuery('<img id="zoom_03" class="img-responsive" src="' + dataimagen + '" data-zoom-image="' + dataimagenzoom + '"/>');
      ...
      jQuery("#divimagengrande").fadeOut(function() {
        // Reemplazamos el elemento original con el clon
        jQuery("#zoom_03").replaceWith(newImage);

        // Volvemos a inicializar el elevatezoom
        newImage.elevateZoom();
