...
jQuery("document").ready(function() {
  // Verificamos que se haya cargado completamente jQuery
  // ...
  ...
  jQuery("#galeria a").click(function() {
    ...
    if (dataimagen === undefined) {
      ...
      jQuery("#divimagengrande").fadeOut(function() {
        ...
        // Manejamos las imágenes pequeñas después de cambiar la variación
        // Puedes ajustar el selector según la estructura HTML de tus imágenes pequeñas
        jQuery("#galeria a").removeClass("seleccionada"); // Elimina la clase "seleccionada" de todos los enlaces
        jQuery(this).addClass("seleccionada"); // Agrega la clase "seleccionada" al enlace actual
      });
