...
// Asegúrate de que se haya cargado completamente jQuery
  ...
  jQuery("#galeria a").click(function () {
    ...
    // Si no es indefinida
      ...
      jQuery("#divimagengrande").fadeOut(function () {
        ...
        var nuevaImagen = '<img id="zoom_03" class="img-responsive" src="' + dataimagen + '" data-zoom-image="' + dataimagenzoom + '"/>';

        jQuery("#divimagengrande").html(nuevaImagen);

        // Eliminamos la instancia anterior del plugin "elevateZoom" antes de volver a inicializarla
        jQuery("#zoom_03").removeData('elevateZoom');
