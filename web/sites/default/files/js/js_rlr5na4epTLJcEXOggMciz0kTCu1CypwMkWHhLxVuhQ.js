...
jQuery(function() {
  ...
  jQuery("#galeria a").click(function() {
    // Creamos variables para obtener las imágenes
    var dataimagen = jQuery(this).data("image");
    var dataimagenzoom = jQuery(this).data("zoom-image");

    // Verificamos si recibimos una imagen indefinida
    if (!dataimagen) {
      console.log("El valor es undefined.");
    } else {
      // Hacemos un efecto fadeout para que desaparezca todo lo que está dentro del divimagengrande
      jQuery("#divimagengrande").fadeOut(function() {
        // Destruir el plugin ElevateZoom antes de cambiar la imagen
        jQuery("#zoom_03").elevateZoom("destroy");
