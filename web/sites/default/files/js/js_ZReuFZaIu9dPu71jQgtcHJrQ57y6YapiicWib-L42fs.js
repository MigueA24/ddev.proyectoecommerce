...
// Evento personalizado para manejar el cambio de variación
function emitirCambioVariacion(dataimagen, dataimagenzoom) {
  var eventoCambioVariacion = new CustomEvent('cambioVariacion', { detail: { dataimagen, dataimagenzoom } });
  document.dispatchEvent(eventoCambioVariacion);
}

// Función para actualizar el slider
function actualizarSlider(dataimagen, dataimagenzoom) {
...
// Evento click en el enlace de la galería
jQuery("#galeria a").click(function() {
  ...
  if (dataimagen !== undefined) {
    ...
    emitirCambioVariacion(dataimagen, dataimagenzoom);
    return false; // Para evitar que el enlace se ejecute
  }
});

// Escucha el evento personalizado y actualiza el slider
document.addEventListener('cambioVariacion', function(event) {
  var dataimagen = event.detail.dataimagen;
  var dataimagenzoom = event.detail.dataimagenzoom;
  actualizarSlider(dataimagen, dataimagenzoom);
});
...
jQuery("document").ready(function() {
  ...
  jQuery("#galeria a").click(function() {
    ...
    if (dataimagen === undefined) {
      ...
      // emite el evento personalizado para manejar el cambio de variación
      emitirCambioVariacion(dataimagen, dataimagenzoom);
      return false;
    }
  });
